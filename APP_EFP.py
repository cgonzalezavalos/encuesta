...
# Definir un diccionario de colores para las categorías de minimos y maximos por caracteristicas de comparación
categoria_colors = {
    'Minimo': 'orange',
    'Maximo': 'blue'
}
...
# Crear el gráfico con Plotly Express
graf11 = px.bar(df_indicadores_min_max, x='Indicador', y='Resultado', color='Categoria',color_discrete_map=categoria_colors,title='<b>Servicios con mayor y menor resultado por indicador</b>') #,
